...
| R-15 | The SIM swap guard is experimental and off unless the process and the realm run it, and it needs a carrier that answers CAMARA | Where it is off, whoever had a number moved to a new SIM receives its codes (T-LOG-21) |
