...
| T-TOK-5 | A refresh token stolen and renewed | TA-1, TA-4 | Rotation by default, compared and rotated in one write, and a replay closes the family while leaving the sign in alive (`crates/services/src/oidc/grant.rs:1468`, `crates/store/src/providers/protocol/sessions.rs:547`, `crates/services/src/oidc/grant.rs:1522`) |
...
| T-TOK-9 | Delegation grown wider or deeper than it was given | TA-4 | Scope intersected and never widened, a ceiling of five links, and a bound token cannot be exchanged (`crates/services/src/oidc/grant.rs:1906`, `:1785`, `:1707`) |
