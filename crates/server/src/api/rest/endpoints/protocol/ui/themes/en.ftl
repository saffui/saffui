...
policy-min-length = At least { $n } characters
policy-max-length = At most { $n } characters
policy-digits = At least { $n } digits
policy-upper = At least { $n } upper-case letters
policy-lower = At least { $n } lower-case letters
policy-special = At least { $n } special characters
policy-not-username = Not your username
policy-not-email = Not your email address
...
flash-throttled = Too many failed attempts from this browser or network. Sign-in from here is paused for a while; try again later.
...
sms-sent = A code was texted to you. Enter it below.
sms-code = Texted code
whatsapp-sent = A code was sent to you on WhatsApp. Enter it below.
whatsapp-code = Code received on WhatsApp
code-not-received = No code?
code-by-sms = Get it by text
code-by-whatsapp = Get it on WhatsApp
