...
pub fn migrations() -> Vec<Migration> {
    vec![
        ...
        Migration::Sql(SqlMigration {
            version: 65,
            name: "device_codes",
            sql: include_str!("../migrations/V065__device_codes.sql"),
            transactional: true,
        }),
        Migration::Sql(SqlMigration {
            version: 66,
            name: "realm_session_bounds",
        ...
        Migration::Sql(SqlMigration {
            version: 82,
            name: "realm_subject_door",
            sql: include_str!("../migrations/V082__realm_subject_door.sql"),
            transactional: true,
        }),
        Migration::Sql(SqlMigration {
            version: 83,
            name: "realm_sms",
            sql: include_str!("../migrations/V083__realm_sms.sql"),
            transactional: true,
        }),
        Migration::Sql(SqlMigration {
            version: 84,
            name: "sms_spend",
            sql: include_str!("../migrations/V084__sms_spend.sql"),
            transactional: true,
        }),
        Migration::Sql(SqlMigration {
            version: 85,
        ...
        Migration::Sql(SqlMigration {
            version: 90,
            name: "sod",
            sql: include_str!("../migrations/V090__sod.sql"),
            transactional: true,
        }),
        Migration::Sql(SqlMigration {
            version: 91,
            name: "access_requests",
            sql: include_str!("../migrations/V091__access_requests.sql"),
            transactional: true,
        }),
        Migration::Sql(SqlMigration {
            version: 92,
        ...
        Migration::Sql(SqlMigration {
            version: 94,
            name: "tenant_chain",
            sql: include_str!("../migrations/V094__tenant_chain.sql"),
            transactional: true,
        }),
        Migration::Sql(SqlMigration {
            version: 95,
            name: "realm_features",
            sql: include_str!("../migrations/V095__realm_features.sql"),
            transactional: true,
        }),
        Migration::Sql(SqlMigration {
            version: 96,
            name: "global_realm_names",
            sql: include_str!("../migrations/V096__global_realm_names.sql"),
            transactional: true,
        }),
        Migration::Sql(SqlMigration {
            version: 97,
        ...
        Migration::Sql(SqlMigration {
            version: 102,
            name: "saml_brokering",
            sql: include_str!("../migrations/V102__saml_brokering.sql"),
            transactional: true,
        }),
        Migration::Sql(SqlMigration {
            version: 103,
            name: "security_notices",
            sql: include_str!("../migrations/V103__security_notices.sql"),
            transactional: true,
        }),
        Migration::Sql(SqlMigration {
            version: 104,
            name: "security_notice_recipients",
